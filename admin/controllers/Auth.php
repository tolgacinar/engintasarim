		...
		if (isset($_POST['identity'])) {
			...
			if ($this->form_validation->run() === TRUE) {
				...
				if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
					$this->layout->json(true, ["message" => $this->ion_auth->messages()]);
				} else {
					$this->layout->json(false, ["message" => $this->ion_auth->errors()]);
				}
			} else {
				$this->layout->json(false, ['message' => validation_errors()]);
			}
		}else {
